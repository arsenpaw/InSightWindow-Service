...
namespace InSightWindowAPI.Migrations
{
    ...
    [Migration("20241207162607_MakeTokenUnique")]
    partial class MakeTokenUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.Entity.FireBaseToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.Entity.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.Entity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.Entity.UserFireBaseTokens", b =>
                {
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.DeviceModel.Device", b =>
                {
                    b.HasOne("InSightWindowAPI.Models.Entity.User", "User")
                        .WithMany("Devices")
            ...
            modelBuilder.Entity("InSightWindowAPI.Models.Entity.UserFireBaseTokens", b =>
                {
                    b.HasOne("InSightWindowAPI.Models.Entity.FireBaseToken", "FireBaseToken")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("InSightWindowAPI.Models.Entity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
